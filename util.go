...
func headingv2ll(v Point2LL, magCorrection float32) float32 {
	...
	angle := degrees(atan2(v[0]*sim.NmPerLongitude, v[1]*sim.NmPerLatitude))
...
func nmlength2ll(a Point2LL) float32 {
	x := a[0] * sim.NmPerLongitude
	y := a[1] * sim.NmPerLatitude
...
func nm2ll(p [2]float32) Point2LL {
	return Point2LL{p[0] / sim.NmPerLongitude, p[1] / sim.NmPerLatitude}
}
...
func ll2nm(p Point2LL) [2]float32 {
	return [2]float32{p[0] * sim.NmPerLongitude, p[1] * sim.NmPerLatitude}
}
