...
- Facility engineering: Gus Agostinho, AsianEvxn, Connor Allen, anguse, Elliot B, boganbruce, Adam Bolek, Brody Carty, Lucas Chan, CiceroIsBack, Aaron Flett, Mike Fries, Ryan G, Gecko, Giovanni, Ryan H, Thomas Halpin, Ethan Hawes, Jason Helkenberg, Trey Hensley, Noah Hunt, Elijah J, Jake, Austin Jenkins, Ketan K, Mike K, Allison L, Josh Lambert, Kayden Lambert, Mike LeGall, Jonah Lefkoff, Jud Lopez, Jake Magee, Ethan Malimon, manaphy, McNugget, Jace Martin, Michael McConnell, Merry, Yahya Nazimuddin, Justin Nguyen, obamna, Peyton, rome, Shane, Andrew S, Logan S, Zach Styka, Arya T, Nelson T, Tyler Temerowski, Eli Thompson, Michael Trokel, Samuel Valencia, Gavin Velicevic, and Jackson Verdoorn.
...
var secondaryAcCommands = [][3]string{
	...
	{"*I_fix*/_radial*[O]", `"Intercept the _fix_ _radial_ radial", inbound unless *O* is appended for outbound.`,
		"*IRBV/065*, *ICAMRN/040O*"},
	...
	{"*S_kts*/U_fix*/_kts*[/U_fix*/_kts*]...", `Compound speed: multiple speed segments separated by fixes. Each may have +/-.`, "*S250+/UFIX1/210-/UFIX2/180+*"},
	...
	{"*DVS*", `"Descend via the STAR"`, "*DVS*"},
	{"*DVS/A_alt*", `"Descend via the STAR, except maintain _alt_."`, "*DVS/A120*"},
