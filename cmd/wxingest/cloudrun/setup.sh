#!/bin/bash
# One-time GCP setup for running wxingest and wxpackage as Cloud Run jobs;
# requires gcloud authenticated with sufficient permissions on the project.
...
# Both the wxingest and wxpackage images live in this repository.
...
# than VICE_GCS_CREDENTIALS) to access the bucket. objectAdmin also covers
# the wxpackage job's Cloud Storage volume mount of the bucket.
