...
type typeParser interface {
	...
	Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (value any, remaining string, matched bool, err error)
...
func (h *spcParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
...
func (h *trackACIDParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
...
func (h *trackBeaconParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	if len(text) < 4 {
		return nil, text, false, nil
	}
...
func (h *trackIndexParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
...
func (h *trackSuspendedIndexParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	num, remainder, _ := util.CutFunc(text, func(ch rune) bool { return !isNum(byte(ch)) })
...
func (h *slewParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
...
func (h *ghostSlewParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
...
func (h *unassociatedFPParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	if len(text) >= 4 {
...
func (h *acidParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
...
func (h *beaconParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	if len(text) < 4 {
		return nil, text, false, nil
	}
...
func (h *beaconBlockParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	if len(text) < 2 {
		return nil, text, false, nil
	}
...
func (h *tcp1Parser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
...
func (h *tcp2Parser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
...
func (h *triTCPParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
...
func (h *tcwParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	if len(text) < 2 || !isNum(text[0]) || !isAlpha(text[1]) {
		return nil, text, false, nil
	}
...
func (h *artccParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
...
func (h *airportIdParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	if len(text) < 3 {
		return nil, text, false, nil
	}
...
func (h *crdaRegionIdParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	if len(text) < 1 {
		return nil, text, false, nil
	}
...
func (h *numberParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
...
func (h *floatParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	decimalsSeen := 0
...
func (h *tpaFloatParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	i := 0
	num := float32(0)
	for i < len(text) {
		if isNum(text[i]) {
...
func (h *fieldParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
...
func (h *allTextParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	if text == "" {
		return nil, text, false, nil
	}
...
func (h *timeParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	// Need 4 digits
	if len(text) < 4 {
		return nil, text, false, nil
	}
...
func (h *altFilter6Parser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	// Need 6 digits
	if len(text) < 6 {
		return nil, text, false, nil
	}
...
func (h *qlRegionParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
...
func (h *fdamRegionParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
...
func (h *raIndexParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	num, remainder, _ := util.CutFunc(text, func(ch rune) bool { return !isNum(byte(ch)) })
...
func (h *raTextParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	if text == "" {
		return nil, text, false, nil
	}
...
func (h *raLocationParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
...
func parseRALocation(sp *Scope, ctx *scope.Context, text string) (math.Point2LL, string, bool, error) {
...
func (h *posParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
...
func (h *posNormParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	// Only match clicks on empty space, not on tracks. Use SLEW for track clicks.
	if !input.hasClick || input.clickedTrack != nil {
		return nil, text, false, nil
	}
...
func (h *posRawParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	// Only match clicks on empty space, not on tracks. Use SLEW for track clicks.
	if !input.hasClick || input.clickedTrack != nil {
		return nil, text, false, nil
	}
...
func (h *fixParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
...
func (h *qlPositionsParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	if text == "" {
		return nil, text, false, nil
	}
...
func (h *fpACIDParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
	if field == "" {
		return nil, text, false, nil
	}
...
func (h *fpBeaconParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
	if field == "" {
		return nil, text, false, nil
	}
...
func (h *fpSP1Parser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
	if field == "" {
		return nil, text, false, nil
	}
...
func (h *fpTriSP1Parser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
	if field == "" {
		return nil, text, false, nil
	}
...
func (h *fpPlusSP2Parser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
	if field == "" {
		return nil, text, false, nil
	}
...
func (h *fpAltAParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
...
func (h *fpAltPParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
	if alt, ok := parseFpAltitudeField(field); ok {
		var spec sim.FlightPlanSpecifier
...
func (h *fpAltRParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
	if alt, ok := parseFpAltitudeField(field); ok {
		var spec sim.FlightPlanSpecifier
...
func (h *fpTriAltAParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
...
func (h *fpPlusAltAParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
...
func (h *fpPlus2AltRParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
	if field == "" || !strings.HasPrefix(field, "++") {
		return nil, text, false, nil
	}
...
func (h *fpTCPParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
	if field == "" {
		return nil, text, false, nil
	}
...
func (h *fpNumActypeEqParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
	if field == "" {
		return nil, text, false, nil
	}
...
func (h *fpNumAcType4Parser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
	if field == "" {
		return nil, text, false, nil
	}
...
func (h *fpActypeEqParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
...
func (h *fpCoordTimeParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
	if field == "" {
		return nil, text, false, nil
	}
...
func (h *fpFixPairParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
	if field == "" {
		return nil, text, false, nil
	}
...
func (h *fpExitFixParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
...
func (h *fpFlttypeParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
	if field == "" {
		return nil, text, false, nil
	}
...
func (h *fpRulesParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
	if field == "" {
		return nil, text, false, nil
	}
...
func (h *fpRNAVParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
	if field == "R" {
		var spec sim.FlightPlanSpecifier
...
func (h *fpVFRFixesParser) Parse(sp *Scope, ctx *scope.Context, input *CommandInput, text string) (any, string, bool, error) {
	field, remaining := util.CutAtSpace(text)
	if field == "" {
		return nil, text, false, nil
	}
