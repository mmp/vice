...
func (ep *Scope) DisplayName() string { return "ERAM" }

func (ep *Scope) DrawUI(p platform.Platform, config *platform.Config) {
...
func (ep *Scope) DrawInfo(c *client.ControlClient, p platform.Platform, lg *log.Logger) {
